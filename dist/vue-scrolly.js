...
var script = {
  ...
  mounted: function mounted() {
    this.$nextTick(function() {
      ...
      while ((childNode = childNodes[i++])) {
        ...
        className.match('axis-x_top') && (barXt = childNode);
        className.match('axis-x_bottom') && (barXb = childNode);
        className.match('axis-y') && (barY = childNode);
      }

      // If viewport or scrollbars do not exist, stop.
      if (!viewport || (!barXt && !barY)) {
        return;
      }
  ...
  methods: {
    ...
    onMouseDown: function onMouseDown(ref) {
      ...
      var self = this;
      var ref$1 = this;
      var barXt = ref$1.barXt;
      var barXb = ref$1.barXb;
      var barY = ref$1.barY;
      var ref$2 = this;
      var viewport = ref$2.viewport;
      var addEventListener = window.addEventListener;
      var removeEventListener = window.removeEventListener;
      var isAxisXt = className.match('axis-x_top');
      var isAxisXb = className.match('axis-x_bottom');
      ...
      function onMouseMove(event) {
        ...
        if (isAxisXt && isAxisXb) {
          ...
          scrollLayout.x = barXt.scrollLayout = barXb.scrollLayout = {
            barXt: barXt,
            barXb: barXb,
        ...
        if (isAxisXt && !isAxisXb) {
          ...
          var scrollLeft$1 = viewport.scrollLeft;
          var scrollWidth$1 = viewport.scrollWidth;
          var viewportWidth$1 = viewport.offsetWidth;

          // Get computed bar width where the browser already
          // took account of min-width/max-width constraints.
          var barWidth$1 = bar.offsetWidth;

          // Determine min/max bar position
          var minBarLeft$1 = 0;
          var maxBarLeft$1 = viewportWidth$1 - barWidth$1;

          // Calculate new bar position
          var dx$1 = pageX - initialPageX;
          var barLeft$1 = initialBarLeft + dx$1;
          barLeft$1 < minBarLeft$1 && (barLeft$1 = minBarLeft$1);
          barLeft$1 > maxBarLeft$1 && (barLeft$1 = maxBarLeft$1);

          // Set scrollbar position
          bar.style.left = toPercent(barLeft$1 / viewportWidth$1);
          barXb.style.left = bar.style.left;

          // From the new scrollbar position,
          // set the new viewport scroll position.
          viewport.scrollLeft =
              barLeft$1 / maxBarLeft$1 * (scrollWidth$1 - viewportWidth$1);

          // Determine if new bar position is on edge
          var onLeftEdge$1 = barLeft$1 < minBarLeft$1;
          var onRightEdge$1 = barLeft$1 > maxBarLeft$1;
          var onEdge$1 = onLeftEdge$1 || onRightEdge$1;

          // Determine other scroll layout properties
          var visible$1 = true;
          var canUnlockParentScroll$1 = false;
          var canScrollParent$1 = false;
          scrollLayout.x = barXt.scrollLayout = {
            barXt: barXt,
            ...
            barWidth: barWidth$1,
            barLeft: barLeft$1,
            minBarLeft: minBarLeft$1,
            maxBarLeft: maxBarLeft$1,
            visible: visible$1,
            onLeftEdge: onLeftEdge$1,
            onRightEdge: onRightEdge$1,
            onEdge: onEdge$1,
        ...
        if (!isAxisXt && isAxisXb) {
          ...
          var scrollLeft$2 = viewport.scrollLeft;
          var scrollWidth$2 = viewport.scrollWidth;
          var viewportWidth$2 = viewport.offsetWidth;

          // Get computed bar width where the browser already
          // took account of min-width/max-width constraints.
          var barWidth$2 = bar.offsetWidth;

          // Determine min/max bar position
          var minBarLeft$2 = 0;
          var maxBarLeft$2 = viewportWidth$2 - barWidth$2;

          // Calculate new bar position
          var dx$2 = pageX - initialPageX;
          var barLeft$2 = initialBarLeft + dx$2;
          barLeft$2 < minBarLeft$2 && (barLeft$2 = minBarLeft$2);
          barLeft$2 > maxBarLeft$2 && (barLeft$2 = maxBarLeft$2);

          // Set scrollbar position
          bar.style.left = toPercent(barLeft$2 / viewportWidth$2);
          barXt.style.left = bar.style.left;

          // From the new scrollbar position,
          // set the new viewport scroll position.
          viewport.scrollLeft =
              barLeft$2 / maxBarLeft$2 * (scrollWidth$2 - viewportWidth$2);

          // Determine if new bar position is on edge
          var onLeftEdge$2 = barLeft$2 < minBarLeft$2;
          var onRightEdge$2 = barLeft$2 > maxBarLeft$2;
          var onEdge$2 = onLeftEdge$2 || onRightEdge$2;

          // Determine other scroll layout properties
          var visible$2 = true;
          var canUnlockParentScroll$2 = false;
          var canScrollParent$2 = false;
          scrollLayout.x = barXb.scrollLayout = {
            barXb: barXb,
            ...
            barWidth: barWidth$2,
            barLeft: barLeft$2,
            minBarLeft: minBarLeft$2,
            maxBarLeft: maxBarLeft$2,
            visible: visible$2,
            onLeftEdge: onLeftEdge$2,
            onRightEdge: onRightEdge$2,
            onEdge: onEdge$2,
            canUnlockParentScroll: canUnlockParentScroll$2,
            canScrollParent: canScrollParent$2,
          };
        }
        ...
        if (isAxisY) {
          ...
          var onEdge$3 = onTopEdge || onBottomEdge;

          // Determine other scroll layout properties
          var visible$3 = true;
          var canUnlockParentScroll$3 = false;
          var canScrollParent$3 = false;
          var scrolled$3 = true;
          ...
          scrollLayout.y = barY.scrollLayout = {
            ...
            onEdge: onEdge$3,
            visible: visible$3,
            canUnlockParentScroll: canUnlockParentScroll$3,
            canScrollParent: canScrollParent$3,
            scrolled: scrolled$3,
          };
        }
    ...
    onMouseLeave: function onMouseLeave(event) {
      ...
      var barXb = ref.barXb;
      var barY = ref.barY;
      barXt && (barXt.scrollLayout = null);
      barXb && (barXb.scrollLayout = null);
    ...
    refreshScrollLayout: function refreshScrollLayout(dx, dy) {
      ...
      if (barXt) {
        ...
        var barWidth = barXt.offsetWidth;
        ...
        var previousScrollLayout = barXt.scrollLayout || {};
      ...
      if (barXb) {
        ...
        barStyle$1.width = toPercent(viewportWidth$1 / scrollWidth$1);

        // Get computed bar width
        var barWidth$1 = barXb.offsetWidth;
        ...
        // Calculate new bar position
        var barLeft$1 =
            scrollLeft$1 / (scrollWidth$1 - viewportWidth$1) * maxBarLeft$1 || 0;
        ...
        // If new bar position is on edge,
        // ensure it stays within min/max position.
        onLeftEdge$1 && (barLeft$1 = minBarLeft$1);
        onRightEdge$1 && (barLeft$1 = maxBarLeft$1);

        // Set bar position
        barStyle$1.left = toPercent(barLeft$1 / viewportWidth$1);

        // Determine if bar needs to be shown
        var visible$1 = barWidth$1 < viewportWidth$1;
        ...
        // Get previous scroll layout to determine
        // if we can unlock parent scrolling
        var previousScrollLayout$1 = barXb.scrollLayout || {};
        ...
        // Allow scrolling of parent...
        var canScrollParent$1 = !!// ...if parent scrolling was previously unlocked,
            // continue let user scroll parent body.
            (
                couldScrollParent$1 ||
                // ...if scrollbar reached the edge of the viewport,
      ...
      if (barY) {
        ...
        // Get bar style
        var barStyle$2 = barY.style;

        // Set the height of the bar to let the browser
        // adjust to min-height/max-height constraints.
        barStyle$2.visibility = 'hidden';
        barStyle$2.display = 'block';
        barStyle$2.height = toPercent(viewportHeight / scrollHeight);
        ...
        var onTopEdge = barTop <= minBarTop;
        var onBottomEdge = barTop >= maxBarTop;
        var onEdge$2 = onTopEdge || onBottomEdge;
        ...
        // Set bar position
        barStyle$2.top = toPercent(barTop / viewportHeight);

        // Determine if bar needs to be shown
        var visible$2 = barHeight < viewportHeight;
        barStyle$2.display = visible$2 ? 'block' : 'none';
        barStyle$2.visibility = 'visible';

        // Determine if there's enough inertia
        // to unlock parent scrolling.
        var canUnlockParentScroll$2 =
          Math.abs(dy) > PARENT_SCROLL_ACTIVATION_POINT;

        // Get previous scroll layout to determine
        // if we can unlock parent scrolling
        var previousScrollLayout$2 = barY.scrollLayout || {};
        var ref$2 = previousScrollLayout$2;
        var wasOnEdge$2 = ref$2.onEdge;
        var couldUnlockParentScroll$2 = ref$2.canUnlockParentScroll;
        var couldScrollParent$2 = ref$2.canScrollParent;

        // Allow scrolling of parent...
        var canScrollParent$2 = !!// ...if scrollbar is on edge and...
        (
          onEdge$2 &&
          ...
          (couldScrollParent$2 ||
            ...
            // and user scrolled with enough inertia with
            // the intention to scroll parent body.
            (wasOnEdge$2 && couldUnlockParentScroll$2))
        );
...
__vue_render__._withStripped = true;
  ...
  var __vue_inject_styles__ = function (inject) {
    if (!inject) { return }
    inject("data-v-f989f26c_0", { source: ".scrolly {\n  position: relative;\n}\n.scrolly .scrolly-bar {\n  opacity: 0;\n}\n.scrolly:hover .scrolly-bar, .scrolly.is-scrolling .scrolly-bar {\n  opacity: 1;\n}\n.scrolly-viewport {\n  position: absolute;\n  overflow: hidden;\n  width: 100%;\n  height: 100%;\n  z-index: 1;\n}\n.scrolly-bar {\n  position: absolute;\n  border: 7px solid transparent;\n  cursor: pointer;\n  z-index: 2;\n  transition: opacity 0.1s ease;\n}\n.scrolly-bar:before {\n  position: absolute;\n  width: 100%;\n  height: 100%;\n  content: \" \";\n  background: rgba(0, 0, 0, 0.3);\n  border-radius: 7px;\n  transition: background 0.2s ease;\n}\n.scrolly-bar:hover:before {\n  background: rgba(0, 0, 0, 0.6);\n}\n.scrolly-bar.axis-x {\n  left: 0;\n  bottom: unset;\n  top: 0;\n  width: 100%;\n  height: 21px;\n  min-width: 20%;\n  max-width: 100%;\n}\n.scrolly-bar.axis-x_bottom {\n  top: unset;\n  bottom: 0;\n}\n.scrolly-bar.axis-y {\n  top: 0;\n  right: 0;\n  width: 21px;\n  height: 100%;\n  min-height: 20%;\n  max-height: 100%;\n}\n\n/*# sourceMappingURL=Scrolly.vue.map */", map: {"version":3,"sources":["/Users/user/Downloads/vue-scrolly-master/src/Scrolly.vue","Scrolly.vue"],"names":[],"mappings":"AAWA;EACA,kBAAA;ACVA;ADYA;EACA,UAAA;ACVA;ADeA;EACA,UAAA;ACbA;ADkBA;EACA,kBAAA;EACA,gBAAA;EACA,WAAA;EACA,YAAA;EACA,UAAA;ACfA;ADkBA;EACA,kBAAA;EACA,6BAAA;EACA,eAAA;EACA,UAAA;EACA,6BAAA;ACfA;ADiBA;EACA,kBAAA;EACA,WAAA;EACA,YAAA;EACA,YAAA;EACA,8BAAA;EACA,kBAtCA;EAuCA,gCAAA;ACfA;ADmBA;EACA,8BAAA;ACjBA;ADsBA;EACA,OAAA;EACA,aAAA;EACA,MAAA;EACA,WAAA;EACA,YAAA;EACA,cAAA;EACA,eAAA;ACnBA;ADsBA;EACA,UAAA;EACA,SAAA;ACnBA;ADsBA;EACA,MAAA;EACA,QAAA;EACA,WAAA;EACA,YAAA;EACA,eAAA;EACA,gBAAA;ACnBA;;AAEA,sCAAsC","file":"Scrolly.vue","sourcesContent":["<template>\n<div :class=\"classnames\" @mouseenter=\"onMouseEnter\" @mousedown=\"onMouseDown\" @mouseleave=\"onMouseLeave\">\n  <slot></slot>\n</div>\n</template>\n\n<script src=\"./Scrolly.js\"></script>\n\n<style lang=\"scss\">\n$scrolly-bar-size: 7px;\n\n.scrolly {\n  position: relative;\n\n  .scrolly-bar {\n    opacity: 0;\n  }\n\n  &:hover,\n  &.is-scrolling {\n    .scrolly-bar {\n      opacity: 1;\n    }\n  }\n}\n\n.scrolly-viewport {\n  position: absolute;\n  overflow: hidden;\n  width: 100%;\n  height: 100%;\n  z-index: 1;\n}\n\n.scrolly-bar {\n  position: absolute;\n  border: $scrolly-bar-size solid transparent;\n  cursor: pointer;\n  z-index: 2;\n  transition: opacity .1s ease;\n\n  &:before {\n    position: absolute;\n    width: 100%;\n    height: 100%;\n    content: \" \";\n    background: rgba(0, 0, 0, 0.3);\n    border-radius: $scrolly-bar-size;\n    transition: background .2s ease;\n  }\n\n  &:hover {\n    &:before {\n      background: rgba(0, 0, 0, 0.6);\n    }\n  }\n}\n\n.scrolly-bar.axis-x {\n  left: 0;\n  bottom: unset;\n  top: 0;\n  width: 100%;\n  height: $scrolly-bar-size * 3;\n  min-width: 20%;\n  max-width: 100%;\n}\n\n.scrolly-bar.axis-x_bottom {\n  top: unset;\n  bottom: 0;\n}\n\n.scrolly-bar.axis-y {\n  top: 0;\n  right: 0;\n  width: $scrolly-bar-size * 3;\n  height: 100%;\n  min-height: 20%;\n  max-height: 100%;\n}\n</style>\n",".scrolly {\n  position: relative;\n}\n.scrolly .scrolly-bar {\n  opacity: 0;\n}\n.scrolly:hover .scrolly-bar, .scrolly.is-scrolling .scrolly-bar {\n  opacity: 1;\n}\n\n.scrolly-viewport {\n  position: absolute;\n  overflow: hidden;\n  width: 100%;\n  height: 100%;\n  z-index: 1;\n}\n\n.scrolly-bar {\n  position: absolute;\n  border: 7px solid transparent;\n  cursor: pointer;\n  z-index: 2;\n  transition: opacity 0.1s ease;\n}\n.scrolly-bar:before {\n  position: absolute;\n  width: 100%;\n  height: 100%;\n  content: \" \";\n  background: rgba(0, 0, 0, 0.3);\n  border-radius: 7px;\n  transition: background 0.2s ease;\n}\n.scrolly-bar:hover:before {\n  background: rgba(0, 0, 0, 0.6);\n}\n\n.scrolly-bar.axis-x {\n  left: 0;\n  bottom: unset;\n  top: 0;\n  width: 100%;\n  height: 21px;\n  min-width: 20%;\n  max-width: 100%;\n}\n\n.scrolly-bar.axis-x_bottom {\n  top: unset;\n  bottom: 0;\n}\n\n.scrolly-bar.axis-y {\n  top: 0;\n  right: 0;\n  width: 21px;\n  height: 100%;\n  min-height: 20%;\n  max-height: 100%;\n}\n\n/*# sourceMappingURL=Scrolly.vue.map */"]}, media: undefined });
...
if (typeof window !== 'undefined' && window.Vue) {
  window.Vue.component('scrolly', __vue_component__);
  window.Vue.component('scrolly-viewport', __vue_component__$1);
  window.Vue.component('scrolly-bar', __vue_component__$2);
}

exports.Scrolly = __vue_component__;
exports.ScrollyViewport = __vue_component__$1;
exports.ScrollyBar = __vue_component__$2;
